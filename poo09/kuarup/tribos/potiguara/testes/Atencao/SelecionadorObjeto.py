...
class Posicionador():
    ...
    def exibe(self,obj):
        ...
        if (obj.estado == 0):
            ...
            if (self.auxAcesso == 1):
                remontagem.esqueleto.x = self.objAnterior.esqueleto.x + 35
            else: #primeiro acesso da classe
                remontagem.esqueleto.x = -25
#                remontagem.esqueleto.y = 40 #posicao vertical(y) de amostragem das escolas
                self.auxAcesso = 1

            remontagem.esqueleto.y = 0
...
#            remontagem.letraAnterior = self.letraAnterior
            ...
            self.objAnterior.esqueleto.x = remontagem.esqueleto.x - 35
