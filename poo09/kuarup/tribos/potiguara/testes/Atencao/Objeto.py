...
class Objeto():
        ...
        def desenha(self,obj='caixa',cor=color.blue):
                if (obj == 'caixa'):
                        ...
                        self.objeto = cylinder(frame=self.esqueleto,pos=(0,0,0),axis=(0,1.2*self.escala,0),radius=0.02*self.escala,color = cor)
                elif (obj == 'piramide'):
                        ...
                        self.objeto = ellipsoid(frame=self.esqueleto,pos=(0,0,0), ength=1.5*self.escala, height=2*self.escala, width=0.5*self.escala,color=cor)
