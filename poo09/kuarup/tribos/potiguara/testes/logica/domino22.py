...
class domino22(SerMarinho): 
    def desenha(self, escala=1):
        ...
        A2 = cylinder(frame = self.esqueleto, pos=(4,1.1,-10), axis=(0,1,0), radius=1, color = color.yellow, opacity=1)
        A3 = cylinder(frame = self.esqueleto, pos=(-4,1.1,-3), axis=(0,1,0), radius=1, color = color.yellow, opacity=1)
