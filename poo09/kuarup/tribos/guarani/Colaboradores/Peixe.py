...
class Peixe(SerMarinho, Observer):
    ...
    def colorirCorpo(self, color):
        self.corpo.color1 = color
        self.corpo.color2 = color 
        self.corpo.color3 = color 
        self.corpo.corpo1.color = color
        self.corpo.corpo2.color = color
        self.corpo.corpo3.color = color
