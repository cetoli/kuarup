...
class Tubarao(SerMarinho):
    ...
    def desenha(self, escala=1):
        ...
        Este é o Tutubarão, o terror dos sete mares!!!

        ATENÇÃO Índios: duas coisas a serem feitas:

        1. multiplicar os tamanhos (lenght, width, height e radius) e as posições (pos) de todos os objetos utilizados pela "escala"; e

        2. adicionar TUDO que compõe o seu ser marinho a um frame, no nosso caso: "frame = self.esqueleto".
