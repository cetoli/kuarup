...
public abstract class ValorBase implements Cloneable {
    ...
    public abstract ValorBase instanciarComplexo();
    ...
    /**
         ...
         * @param acumulador.
         */
    public abstract ValorBase aceitarVisita(Visitor visitor, Vetor acumulador);
    ...
    public abstract ValorBase instanciarVetor();

    public abstract ValorBase subtrair(ValorBase atual);
    ...
    /*    *//**
                 ...
                 */
    /*
         * public abstract ValorBase aceitarVisitaOperador(Visitor visitor,
         * Vetor operador);
         */
