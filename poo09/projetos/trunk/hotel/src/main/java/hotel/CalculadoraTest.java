...
public class CalculadoraTest extends junit.framework.TestCase {
    ...
    /**
         * Botao hexadecimal: Digita 11, soma. Botao hexadecimal: Digita 11,
         * soma. Resultado= 22.
         */
	...
	calculad2.entraUm();
	calculad2.entraN();
	calculad2.entraUm(); // não muda para binario.
    ...
    /**
         * Teste: entrar com o número D1N11IH11N1 (1e11+ 0x11e1i) ->
         * 0x1N11I0x11N1.
         */
    ...
    /**
         * Teste: entrar com o número B1NB11IB11ND1 (0b1e0b11 + 0b11e1i) ->
         * 1N3I3N1.
         */
	...
	calculad2.modoBin();
	calculad2.entraUm();
	assertEquals("0b1N1V0b11", calculad2.entraUm());
	...
	assertEquals("0b10V0b100I1", calculad2.comandoSoma());

    }

    /**
         * Teste: B11N1V11VD1V1I1 - 11 ([0b11e1,0b11,1,1+1i]-11) ->
         * 1N1V-8V10V-10I1.
         */
	...
	assertEquals("1N1V-8V10V-10I1", calculad2.comandoSubtrai());
    }

    /**
         * Teste: subtrair 1N1 de D11N1VH11N1 ([11e1+ 0x11e1i]-1e1) ->
         * 10N1V16N1.
         */
	...
	assertEquals("10N1V16N1", calculad2.comandoSubtrai());
    }
