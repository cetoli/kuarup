...
public class CalculadoraTest extends junit.framework.TestCase {
   ...
   /**
    ...
    /**
     * Testa subtrair 1N1 de D11N1VH11N1 ([11e1+ 0x11e1i]-1e1) -> 10N1V16N1.
     */
    public final void testeSubtrai1N1deD11N1VH11N1sai10N1V16N1() {
    	alpha.Calculadora calculad1 = new alpha.Calculadora();
    	calculad1.modoDec();
    	calculad1.entraUm();
    	calculad1.entraUm();
    	...
    	calculad1.entraN();
    	calculad1.entraUm();
    	calculad1.comandoSubtrai();
    	calculad1.modoDec();
    	calculad1.entraUm();
    	calculad1.entraN();
    	calculad1.entraUm();
    	assertEquals("10N1V16N1",calculad1.comandoSubtrai());
    }
}
