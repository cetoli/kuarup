 ...
 */
public class BaseBinariaStrategyTest extends junit.framework.TestCase {

    /**
     * Construtor default para a classe de teste BaseBinariaTest.
     */
    public BaseBinariaStrategyTest() {
    }
    ...
    public void testConverterParaDecimal() {
        BaseBinariaStrategy baseBina1 = new echo.BaseBinariaStrategy();
