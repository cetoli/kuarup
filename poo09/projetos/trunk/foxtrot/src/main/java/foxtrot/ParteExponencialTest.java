 ...
 * hexadecimais.
 */
public class ParteExponencialTest extends junit.framework.TestCase {
  
    /**
     * Construtor default para a classe de teste CompositorParteImaginariaTest.
     */
    public ParteExponencialTest() {
    }
    ...
    /**
     * Testes de Entrada: ADICIONAR PARTE EXPONENCIAL A N�MERO REAL,
     *                    ADICIONAR PARTE EXPONENCIAL A N�MERO IMAGIN�RIO,
     *                    ADICIONAR PARTE EXPONENCIAL A N�MERO COMPLEXO,
    ...
    /**
     * Teste de Entrada: ADICIONAR PARTE EXPONENCIAL A N�MERO COMPLEXO.
     */
    public void testEntraD11ED10ID10ED11() {
        Complexo operando = new Complexo();
        Adicionador adicionador = new ParteReal();
        Adicionador montador = new ParteMantissa();
        adicionador.adicionaParteReal(11, operando, montador);
