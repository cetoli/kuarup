 ...
 */
public class BaseHexadecimalStrategyTest extends junit.framework.TestCase {

    /**
     * Construtor default para a classe de teste testbaseHexa.
     */
    public BaseHexadecimalStrategyTest() {
    }
    ...
    public void testConverterBase1() {
        BaseHexadecimalStrategy baseHexa1 = new echo.BaseHexadecimalStrategy();
    ...
    public void testConverterBase11() {
        echo.BaseHexadecimalStrategy baseHexa1 = new echo.BaseHexadecimalStrategy();
