...
public abstract class ValorBase implements Cloneable {
   ...
   public abstract String limparValor();
     ...
     * Adiciona um digito.
     */
    public abstract String adicionarDigito(String digito, ImpressaoStrategy modo, ImpressaoStrategy modoImpressao);
    /**
	 ...
	 * @param acumulador.
	 */
	public abstract ValorBase aceitarVisita(Visitor visitor, Engenharia acumulador);
